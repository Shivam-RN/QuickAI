import { Edit, Sparkles,ClipboardCopy  } from 'lucide-react'
...
const WriteArticle = () => {
  ...
  if (content) {
    navigator.clipboard.writeText(content)
      .then(() => toast.success("Article copied to clipboard!"))
      .catch(() => toast.error("Failed to copy article."));
  }
};
  ...
  return (
    ...
    text-slate-700'>
      ...
      border-gray-200'>
        ...
        <input onChange={(e)=> setInput(e.target.value)} value={input} type='text' className='w-full p-2 px-3 outline-none text-sm
