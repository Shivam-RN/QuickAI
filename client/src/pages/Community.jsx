...
const imageLikeToggle = async (id) => {
  ...
  return !loading?(
    <div className='flex-l h-full flex flex-col gap-4 p-6'>
      Creations
      <div className='bg-white h-full w-full rounded-xl overflow-y-scroll'>
        {creations.map((creation, index) => (
          ...
          sm:max-w-1/2 lg:max-w-1/3'>
            ...
            <div className='absolute bottom-0 left-0 right-0 gap-2
            items-end justify-between p-3
            bg-gradient-to-t from-black/80 to-transparent text-white
            rounded-b-lg flex flex-col'>
