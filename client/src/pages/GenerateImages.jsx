  ...
  const imageStyle =['Realistic', 'Ghibli style', 'Anime style', 'Cartoon style',
      ...
      const onSubmitHandler=async(e) =>{
        ...
        try {
          ...
          const prompt = `Generate an image of ${input} int he style ${selectedStyle}`
  ...
  return (
    ...
    text-slate-700'>
      ...
      border-gray-200'>
        ...
        <textarea onChange={(e)=> setInput(e.target.value)} value={input} rows={4} className='w-full p-2 px-3 outline-none text-sm
        rounded-md border border-gray-300' placeholder='Describe what you want to see int the image...' required/>
